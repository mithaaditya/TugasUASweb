    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table id="example" class="table table-dark table-striped">
                ...
                <thead>
                    <tr>
                        <th>Nama Pemesan</th><th>Jenis Makanan</th><th>Jumlah Makanan</th><th>Harga Makanan</th><th>Total Harga</th>
                        <th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit-makanan.php?id=<?php echo $row['id_makanan']?>">
                                <button class="bi bi-pencil-square"></button>
                            </a>
                            <a href="hapus-makanan.php?id=<?php echo $row['id_makanan']?>" onclick=" return confirm('Anda yakin menghapus data?')">
