...
<html lang="en">
  ...
  <body>
    ...
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg shadow-sm fixed-top" style="background-color:#1d1d1d ; ">
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link mx-2" href="galeri.php">Galery</a>
                  </li>
                  
                  <li class="nav-item">
                      <a class="nav-link mx-2" href="juruMasak.php">Chefs</a>
                  </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                      aria-expanded="false">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="reservasi.php">Reservation</a></li>
                      
                  </ul>
              </li>
              <li class="nav-item">
                      <a class="nav-link mx-2" href="tampil-reservasi.php">Data Reservation</a>
                  </li> 
              </ul>
